...
class TowerReports {
    ...
    void publishRuntimeReports() {
        ...
        if( config.navigate('report.enabled') )
            files << config.navigate('report.file', ReportConfig.DEF_FILE_NAME)

        if( config.navigate('timeline.enabled') )
            files << config.navigate('timeline.file', TimelineConfig.DEF_FILE_NAME)

        if( config.navigate('trace.enabled') )
            files << config.navigate('trace.file', TraceConfig.DEF_FILE_NAME)

        if( config.navigate('dag.enabled') )
            files << config.navigate('dag.file', DagConfig.DEF_FILE_NAME)
