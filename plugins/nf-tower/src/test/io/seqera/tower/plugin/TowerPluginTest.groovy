 ...
 */
class TowerPluginTest extends Specification {

    def 'should init empty files' () {
        given:
        def tower = new TowerPlugin(Mock(PluginWrapper))
        ...
        and:
        !tower.sessionUuid
        !tower.localCachePath
        !tower.localOutFile
        !tower.localLogFile
        !tower.localTimelineFile
        !tower.localTowerConfig
        !tower.localTowerReports
        !tower.remoteWorkDir
    }
    ...
    def 'should upload cache files' () {
        ...
        def ENV = [
                NXF_UUID:uuid,
                NXF_REMOTE_WORK: remote.toString(),
