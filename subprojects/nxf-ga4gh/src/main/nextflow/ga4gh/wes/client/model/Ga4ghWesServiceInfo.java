...
public class Ga4ghWesServiceInfo {
  ...
  public Ga4ghWesServiceInfo workflowTypeVersions(Map<String, AvailableWorkflowTypesSupportedByThisWES> workflowTypeVersions) {
    this.workflowTypeVersions = workflowTypeVersions;
    return this;
  }

  public Ga4ghWesServiceInfo putWorkflowTypeVersionsItem(String key, AvailableWorkflowTypesSupportedByThisWES workflowTypeVersionsItem) {
