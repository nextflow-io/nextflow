...
public class OUTPUTONLYExecutors {
  ...
  public OUTPUTONLYExecutors imageName(String imageName) {
  ...
  **/
  ...
  public OUTPUTONLYExecutors cmd(List<String> cmd) {
    this.cmd = cmd;
    return this;
  }

  public OUTPUTONLYExecutors addCmdItem(String cmdItem) {
    if (this.cmd == null) {
  ...
  **/
  ...
  public OUTPUTONLYExecutors workdir(String workdir) {
  ...
  **/
  ...
  public OUTPUTONLYExecutors stdin(String stdin) {
    this.stdin = stdin;
    return this;
  }
  ...
  **/
  ...
  public OUTPUTONLYExecutors stdout(String stdout) {
    this.stdout = stdout;
    return this;
  }
  ...
  **/
  ...
  public OUTPUTONLYExecutors stderr(String stderr) {
    this.stderr = stderr;
    return this;
  }
  ...
  **/
  ...
  public OUTPUTONLYExecutors ports(List<OUTPUTONLYPorts> ports) {
    this.ports = ports;
    return this;
  }

  public OUTPUTONLYExecutors addPortsItem(OUTPUTONLYPorts portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public OUTPUTONLYExecutors environ(Map<String, String> environ) {
    this.environ = environ;
    return this;
  }

  public OUTPUTONLYExecutors putEnvironItem(String key, String environItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OUTPUTONLYExecutors ouTPUTONLYExecutors = (OUTPUTONLYExecutors) o;
    return Objects.equals(this.imageName, ouTPUTONLYExecutors.imageName) &&
        Objects.equals(this.cmd, ouTPUTONLYExecutors.cmd) &&
        Objects.equals(this.workdir, ouTPUTONLYExecutors.workdir) &&
        Objects.equals(this.stdin, ouTPUTONLYExecutors.stdin) &&
        Objects.equals(this.stdout, ouTPUTONLYExecutors.stdout) &&
        Objects.equals(this.stderr, ouTPUTONLYExecutors.stderr) &&
        Objects.equals(this.ports, ouTPUTONLYExecutors.ports) &&
        Objects.equals(this.environ, ouTPUTONLYExecutors.environ);
  }
  ...
  public String toString() {
    ...
    sb.append("class OUTPUTONLYExecutors {\n");
