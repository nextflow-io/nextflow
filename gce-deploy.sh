...
echo "export NEXFLOW_DOWNLOAD_URL=http://sekretname.storage.googleapis.com/releases"
#echo "export NEXFLOW_DOWNLOAD_URL=http://nextflow-nextcode-dev.storage.googleapis.com/releases"
