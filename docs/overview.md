...
Read the [Process ](process-page) sections to learn more about these features.
...
Read the [Configuration](config#config-page) section to learn more about the Nextflow configuration file and settings.
