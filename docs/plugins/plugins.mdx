---
title: Plugins
description: Discover and use Nextflow plugins to extend pipeline functionality.
---
...
* `nf-seqera`: Support for [Seqera Platform](https://seqera.io/platform/) and Seqera Intelligent Compute.
...
[dev-plugins-env-vars]: ./developing-plugins#environment-variables
[using-plugins-page]: ./using-plugins
