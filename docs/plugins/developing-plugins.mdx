...
[config-scopes-page]: /nextflow_docs/nextflow_repo/docs/developer/config-scopes.mdx#config-scopes-page
[gradle-plugin-create]: /nextflow_docs/nextflow_repo/docs/guides/gradle-plugin.html#creating-a-plugin
[process-directives]: /nextflow_docs/nextflow_repo/docs/process.mdx#process-directives
