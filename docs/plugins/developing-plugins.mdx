...
description: Create, build, test, and publish Nextflow plugins using the plugin template and Gradle build tools.
---
...
[config-scopes-page]: ../developer/config-scopes#config-scopes
...
[gradle-plugin-test]: ../guides/gradle-plugin#testing-a-plugin
