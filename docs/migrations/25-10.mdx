...
[dev-plugins-extension-points-config]: /nextflow_docs/nextflow_repo/docs/plugins/developing-plugins.mdx#configuration
...
[migrating-static-types]: /nextflow_docs/nextflow_repo/docs/tutorials/static-types.mdx#migrating-to-static-types
[migrating-workflow-outputs]: /nextflow_docs/nextflow_repo/docs/tutorials/workflow-outputs.mdx#migrating-to-workflow-outputs
