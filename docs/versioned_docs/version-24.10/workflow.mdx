...
In Nextflow, a **workflow** is a specialized function for composing [processes][process-page] and dataflow logic:
...
:::note
Typed parameters require the [strict syntax][strict-syntax-page]. Set the `NXF_SYNTAX_PARSER` environment variable to `v2` to enable:
...
<AddedInVersion version="25.10.0">
Workflow outputs are available as a preview in Nextflow [24.04][workflow-outputs-first-preview], [24.10][workflow-outputs-second-preview], and [25.04][workflow-outputs-third-preview].
</AddedInVersion>

:::note
Workflow outputs are intended to replace the [publishDir][process-publishdir] directive. See [Migrating to workflow outputs][migrating-workflow-outputs] for guidance on migrating from `publishDir` to workflow outputs.
:::
...
When using the [strict syntax][strict-syntax-page], workflow takes and emits can specify a type annotation:
...
In the above example, `my_workflow` takes a channel of files (`Channel<Path>`) and emits a dataflow value with a single file (`Value<Path>`). See [Types][stdlib-types] for the list of available types.
...
Dataflow values can be created using the [channel.value][channel-value] factory, and they are created by processes (under [certain conditions][process-out-singleton]).
...
See [Value\<V\>][stdlib-types-value] for the set of available methods for dataflow values.
...
:::note
As a best practice, avoid these operators when [type checking][preparing-static-types] is enabled. Using these operators will prevent the type checker from validating your code.
:::
...
[channel-factory]: /docs/reference/channel.mdx
[channel-value]: /docs/reference/channel.mdx#value
[cli-params]: /docs/cli.mdx#pipeline-parameters
[config-process-selectors]: /docs/config.mdx#process-selectors
[config-workflow]: /docs/reference/config.mdx#workflow
[dsl1-page]: /docs/migrations/dsl1.mdx
[migrating-workflow-outputs]: /docs/tutorials/workflow-outputs.mdx
[operator-collect]: /docs/reference/operator.mdx#collect
[operator-combine]: /docs/reference/operator.mdx#combine
[operator-filter]: /docs/reference/operator.mdx#filter
[operator-flatMap]: /docs/reference/operator.mdx#flatmap
[operator-grouptuple]: /docs/reference/operator.mdx#grouptuple
[operator-join]: /docs/reference/operator.mdx#join
[operator-page]: /docs/reference/operator.mdx
[preparing-static-types]: /docs/tutorials/static-types.mdx
[process-out-singleton]: /docs/process.mdx#singleton-outputs
[process-page]: /docs/process.mdx
[stdlib-types]: /docs/reference/stdlib-types.mdx
[stdlib-types-value]: /docs/reference/stdlib-types.mdx#value
[workflow-outputs-first-preview]: /docs/tutorials/workflow-outputs.mdx#first-preview
[workflow-outputs-second-preview]: /docs/migrations/24-10.mdx
[workflow-outputs-third-preview]: /docs/migrations/25-04.mdx
[module-aliases]: /docs/module.mdx#module-aliases
[process-naming-outputs]: /docs/process.mdx#naming-outputs
[operator-map]: /docs/reference/operator.mdx#map
[operator-mix]: /docs/reference/operator.mdx#mix
[operator-view]: /docs/reference/operator.mdx#view
[process-publishdir]: /docs/reference/process.mdx#publishdir
[stdlib-types-boolean]: /docs/reference/stdlib-types.mdx#boolean
[stdlib-types-float]: /docs/reference/stdlib-types.mdx#float
[stdlib-types-integer]: /docs/reference/stdlib-types.mdx#integer
[stdlib-types-path]: /docs/reference/stdlib-types.mdx#path
[stdlib-types-string]: /docs/reference/stdlib-types.mdx#string
[strict-syntax-page]: /docs/strict-syntax.mdx
[workflow-outputs-first-preview]: /docs/reference/syntax.mdx#workflow
[workflow-outputs-second-preview]: /docs/migrations/24-10.mdx#workflow-outputs-second-preview
[workflow-outputs-third-preview]: /docs/migrations/25-04.mdx#workflow-outputs-third-preview
