...
[cache-global-var-race-condition]: /docs/cache-and-resume.mdx#race-condition-on-a-global-variable
[channel-page]: /docs/channel.mdx
...
[stdlib-types-map]: /docs/reference/stdlib-types.mdx#mapkv
[stdlib-types-tuple]: /docs/reference/stdlib-types.mdx#tuple
