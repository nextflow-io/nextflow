...
<div style={{ display: "flex", flexWrap: "wrap", gap: "8px", alignItems: "center" }}>
    <a href="https://github.com/nextflow-io/nextflow/actions/workflows/build.yml?query=branch%3Amaster+event%3Apush" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/github/actions/workflow/status/nextflow-io/nextflow/build.yml?branch=master&label=Nextflow%20CI&colorB=58bd9f&style=popout" alt="Nextflow CI" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
    <a href="https://github.com/nextflow-io/nextflow/releases/latest" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/github/release/nextflow-io/nextflow.svg?colorB=58bd9f&style=popout" alt="Nextflow version" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
    <a href="https://twitter.com/nextflowio" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/twitter/url/https/nextflowio.svg?colorB=58bd9f&&label=%40nextflow&style=popout" alt="Nextflow Twitter" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
    <a href="https://www.nature.com/articles/nbt.3820" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/badge/Published-Nature%20Biotechnology-26af64.svg?colorB=58bd9f&style=popout" alt="Nextflow publication" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
    <a href="http://bioconda.github.io/recipes/nextflow/README.html" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/badge/install%20with-bioconda-brightgreen.svg?colorB=58bd9f&style=popout" alt="Install with Bioconda" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
    <a href="https://github.com/nextflow-io/nextflow/blob/master/COPYING" style={{ display: "block", lineHeight: 0 }}>
        <img src="https://img.shields.io/github/license/nextflow-io/nextflow.svg?colorB=58bd9f&style=popout" alt="Nextflow license" style={{ display: "block", margin: 0, padding: 0, height: "20px" }} />
    </a>
</div>
...
Contributions to Nextflow are welcome. See [Contributing][contributing-page] for details.
...
[contributing-page]: /docs/developer/index.mdx
[overview-page]: /docs/overview.mdx
[install-page]: /docs/install.mdx
[devenv-page]: /docs/developer-env.mdx
[devenv-nextflow]: /docs/developer-env.mdx#nextflow
[your-first-script]: /docs/your-first-script.mdx
