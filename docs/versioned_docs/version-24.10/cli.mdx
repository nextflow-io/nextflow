...
For the complete reference of all commands, subcommands, and options, see [CLI reference][cli-reference].
...
[cli-auth]: /docs/reference/cli.mdx#auth
[cli-clone]: /docs/reference/cli.mdx#clone
[cli-config]: /docs/reference/cli.mdx#config
[cli-drop]: /docs/reference/cli.mdx#drop
[cli-fs]: /docs/reference/cli.mdx#fs
[cli-inspect]: /docs/reference/cli.mdx#inspect
[cli-kuberun]: /docs/reference/cli.mdx#kuberun
[cli-launch]: /docs/reference/cli.mdx#launch
[cli-lineage]: /docs/reference/cli.mdx#lineage
[cli-lint]: /docs/reference/cli.mdx#lint
[cli-params]: /docs/cli.mdx#pipeline-parameters
[cli-plugin]: /docs/reference/cli.mdx#plugin
[cli-pull]: /docs/reference/cli.mdx#pull
[cli-reference]: /docs/reference/cli.mdx
[cli-run]: /docs/reference/cli.mdx#run
[cli-secrets]: /docs/reference/cli.mdx#secrets
[cli-view]: /docs/reference/cli.mdx#view
[config-constants]: /docs/config.mdx#constants
[config-env-vars]: /docs/reference/env-vars.mdx
[config-page]: /docs/config.mdx
[config-params]: /docs/config.mdx#parameters
[data-lineage-page]: /docs/tutorials/data-lineage.mdx
[git-page]: /docs/cli.mdx
