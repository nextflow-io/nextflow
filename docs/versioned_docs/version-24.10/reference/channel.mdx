...
[operator-ifempty]: /docs/reference/operator.mdx#ifempty
[process-additional-options]: /docs/reference/process.mdx#options
[operator-take]: /docs/reference/operator.mdx#take
[operator-until]: /docs/reference/operator.mdx#until
