...
[cache-nondeterministic-inputs]: /docs/cache-and-resume.mdx#non-deterministic-process-inputs
[dataflow-page]: /docs/channel.mdx
[channel-factory]: /docs/reference/channel.mdx
[operator-page]: /docs/reference/operator.mdx
[operator-splitfasta]: /docs/reference/operator.mdx#splitfasta
[operator-splitfastq]: /docs/reference/operator.mdx#splitfastq
[operator-splitjson]: /docs/reference/operator.mdx#splitjson
[operator-splittext]: /docs/reference/operator.mdx#splittext
[operator-splitcsv]: /docs/reference/operator.mdx#splitcsv
[script-list]: /docs/script.mdx#lists
[script-map]: /docs/script.mdx#maps
[script-strings]: /docs/script.mdx#strings
[stdlib-types-bag]: /docs/reference/stdlib-types.mdx#bage
[stdlib-types-iterable]: /docs/reference/stdlib-types.mdx#iterablee
[stdlib-types-list]: /docs/reference/stdlib-types.mdx#liste
[stdlib-types-set]: /docs/reference/stdlib-types.mdx#sete