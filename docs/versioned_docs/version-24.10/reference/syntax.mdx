...
[inputs-and-outputs-typed]: /docs/reference/process.mdx#inputs-and-outputs-typed
[process-reference-typed]: /docs/process-typed.mdx
[process-shell]: /docs/process.mdx#shell
[process-when]: /docs/process.mdx#when
[script-closure]: /docs/script.mdx#closures
[stdlib-namespaces-global]: /docs/reference/stdlib-namespaces.mdx
[stdlib-page]: /docs/reference/stdlib.mdx
