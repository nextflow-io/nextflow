...
[containers-page]: /docs/container.mdx
[devenv-docker]: /docs/developer-env.mdx#docker
[devenv-extensions]: /docs/developer-env.mdx#extensions
[devenv-git]: /docs/developer-env.mdx#git
[devenv-nextflow]: /docs/developer-env.mdx#nextflow
[devenv-vscode]: /docs/developer-env.mdx#vs-code
[devenv-wsl]: /docs/developer-env.mdx#windows-subsystem-for-linux
