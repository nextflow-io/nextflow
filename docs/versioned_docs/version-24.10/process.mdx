...
:::note
Input repeaters do not support tuples. Use the [`combine`][operator-combine] operator to combine the repeated input with the other inputs to produce all of the desired input combinations.
:::
...
In the above example, the [memory][process-memory] is set according to previous trace record metrics. In the first attempt, when no trace metrics are available, it is set to 1 GB. In each subsequent attempt, the requested memory is doubled. 

:::note
Many fields from the previous task attempts are accessible. See [Trace file][trace-report] for a list of available fields.
:::
...
[channel-types]: /docs/channel.mdx#channel-types
[channel-type-value]: /docs/channel.mdx#value-channel
[channel-value]: /docs/reference/channel.mdx#value
[executor-page]: /docs/executor.mdx
...
[operator-flatten]: /docs/reference/operator.mdx#flatten
[operator-cross]: /docs/reference/operator.mdx#cross
[operator-merge]: /docs/reference/operator.mdx#merge
[process-conda]: /docs/reference/process.mdx#conda
[process-container]: /docs/reference/process.mdx#container
[process-cpus]: /docs/reference/process.mdx#cpus
[process-error-strategy]: /docs/reference/process.mdx#errorstrategy
[process-executor]: /docs/reference/process.mdx#executor
[process-input-path]: /docs/process.mdx#input-files-path
[process-label]: /docs/reference/process.mdx#label
[process-maxforks]: /docs/reference/process.mdx#maxforks
[process-maxretries]: /docs/reference/process.mdx#maxretries
[process-memory]: /docs/reference/process.mdx#memory
[process-out-singleton]: /docs/process.mdx#singleton-outputs
[process-out-tuple]: /docs/process.mdx#output-tuples-tuple
[process-queue]: /docs/nextflow_repo/docs/reference/process.mdx#queue
[process-tag]: /docs/reference/process.mdx#tag
[process-time]: /docs/reference/process.mdx#time
[process-script]: /docs/process.mdx#script
[process-multiple-inputs]: /docs/process.mdx#multiple-inputs
[process-reference-directives]: /docs/reference/process.mdx#directives
[process-reference-inputs]: /docs/reference/process.mdx#inputs
[process-reference-outputs]: /docs/reference/process.mdx#outputs
[process-template]: /docs/process.mdx#template
[script-closure]: /docs/script.mdx#closures
[script-tuples]: /docs/script.mdx#tuples
[stdlib-types-path]: /docs/reference/stdlib-types.mdx#path
[strict-syntax-page]: /docs/strict-syntax.mdx
[string-interpolation]: /docs/script.mdx#string-interpolation
[syntax-function]: /docs/reference/syntax.mdx#function
[syntax-process]: /docs/reference/syntax.mdx#process
[trace-report]: /docs/reports.mdx#trace-file
[workflow-process-invocation]: /docs/workflow.mdx#calling-processes-and-workflows
