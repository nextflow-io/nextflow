...
`conda.enabled`
: Enable the use of Conda environments (default: `false`).
...
: :::{versionadded} 23.09.0-edge
  :::
: When `true`, log a warning (or throw an error in strict mode) if an unrecognized config option is specified (default: `false`).
