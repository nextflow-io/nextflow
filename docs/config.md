...
: :::{versionadded} 23.07.0-edge
  :::
: Controls the maximum depth at which to render subworkflows (default: no limit).
...
: :::{versionadded} 23.07.0-edge
  :::
: When `false`, operators are collapsed and empty workflow inputs are removed (default: `false`).
