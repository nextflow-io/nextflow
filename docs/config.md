...
`NXF_DEBUG`
: Defines debugging level for task scripts:

  - `0`: no debug
  - `1`: dump task environment variables in the task log file and trace command script execution
  - `2`: in addition to `1`, trace command wrapper execution
