...
:::note{title="New in version 25.05.0-edge"} 
:::
...
:::note{title="New in version 22.07.0-edge"} 
:::
...
:::warning{title="Changed in version 23.10.0"} 
...
[metrics-page]: /nextflow_docs/nextflow_repo/docs/metrics.mdx
