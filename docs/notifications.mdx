---
title: Notifications
description: Handle workflow completion and error events and send email notifications.
---
...
You can use the `sendMail` function with a [workflow completion handler](#completion-handler) to notify a workflow completion. For example:
