---
title: Updating Nextflow
description: Update, pin, and switch between Nextflow versions.
---
...
See [Migration notes][migrations-page] for a list of migration guides for each stable release. See the [changelog](https://github.com/nextflow-io/nextflow/blob/master/CHANGELOG.md) for an exhaustive list of changes across all releases.
