...
[process-containeroptions]: /nextflow_docs/nextflow_repo/docs/reference/process.mdx#containeroptios
...
[process-memory]: /nextflow_docs/nextflow_repo/docs/reference/process.mdxmemory
