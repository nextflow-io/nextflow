...
**Note**: this setting considers the **total** errors accumulated for a given process, across all instances -- if you want to control the number of times a process **instance** (aka task) can fail, use ``maxRetries``.
