...
The exit code of the task script.

The exit code is only available after the task has been executed (e.g., the [errorStrategy](#errorstrategy) directive may use it).
...
Since the trace record is available after a failed task attempt, it can only be accessed when retrying a failed task execution, and therefore when `task.attempt` is greater than 1. See [Trace file][trace-report] for a list of available fields.
...
[awsbatch-executor]: /docs/executor.mdx#aws-batch
[azurebatch-executor]: /docs/executor.mdx#azure-batch
[cache-resume-page]: /docs/cache-and-resume.mdx
[channel-topic]: /docs/reference/channel.mdx#topic
[config-process-selectors]: /docs/config.mdx#process-selectors
[conda-page]: /docs/conda.mdx
[dynamic-directives]: /docs/process.mdx#dynamic-directives
[dynamic-task-resources]: /docs/process.mdx#dynamic-task-resources
[executor-page]: /docs/executor.mdx
[google-batch-executor]: /docs/executor.mdx#google-cloud-batch
[k8s-executor]: /docs/executor.mdx#kubernetes
...
[process-native]: /docs/process.mdx#native-execution
[getstarted-resume]: /docs/your-first-script.mdx#modify-and-resume
[secrets-page]: /docs/secrets.mdx
[sge-executor]: /docs/executor.mdx#sge
[slurm-executor]: /docs/executor.mdx#slurm
[spack-page]: /docs/spack.mdx
[stdlib-namespaces-workflow]: /docs/reference/stdlib-namespaces.mdx#workflow
[stdlib-types-duration]: /docs/reference/stdlib-types.mdx#duration
[stdlib-types-memoryunit]: /docs/reference/stdlib-types.mdx#memoryunit
[trace-report]: /docs/reports.mdx#trace-file
[wave-page]: /docs/wave.mdx
[workflow-output-def]: /docs/workflow.mdx#workflow-outputs
