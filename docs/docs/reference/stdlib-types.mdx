---
title: Types
description: Reference for the standard types in the Nextflow standard library.
---
...
See [Dataflow][dataflow-page] for an overview of dataflow types. See [Operators (typed)][operator-typed-page] for the set of operators that are recommended for use with static typing.
