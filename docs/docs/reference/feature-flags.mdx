---
title: Feature flags
description: Feature flags in Nextflow
---
...
[migrations-page]: /docs/migrations/25-10.mdx
[module-binaries]: /docs/module.mdx#module-binaries
...
[workflow-recursion]: /docs/workflow.mdx#process-and-workflow-recursion