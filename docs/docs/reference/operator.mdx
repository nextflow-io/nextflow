---
title: Operators
description: Reference for all Nextflow channel operators used to transform, filter, combine, and inspect channel data.
---
...
[operator-tolist]: ./operator#tolist
[operator-tosortedlist]: ./operator#tosortedlist
[preparing-static-types]: ../tutorials/static-types#preparing-for-static-types
