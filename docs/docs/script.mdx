---
title: Scripts
description: An overview of the Nextflow scripting language, including variables, strings, control structures, closures, and use of the Java and Groovy standard libraries.
---
