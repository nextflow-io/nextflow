---
title: Workflows
description: How to define entry workflows and named workflows in Nextflow.
---
...
[stdlib-types-boolean]: ./reference/stdlib-types#boolean
[stdlib-types-float]: ./reference/stdlib-types#float
[stdlib-types-integer]: ./reference/stdlib-types#integer
[stdlib-types-path]: ./reference/stdlib-types#path
[stdlib-types-string]: ./reference/stdlib-types#string
