...
[process-reference-typed]: /nextflow_docs/nextflow_repo/docs/reference/syntax.mdx#process-typed
...
[process-stub]: /nextflow_docs/nextflow_repo/docs/process.html#stub
[stdlib-types]: /nextflow_docs/nextflow_repo/docs/reference/stdlib-types.html#types
