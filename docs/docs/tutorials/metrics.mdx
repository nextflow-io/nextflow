---
title: Understanding task resource metrics
description: How CPU, memory, and I/O resource usage metrics are computed and interpreted.
---
...
:::warning
Memory and storage metrics are reported in bytes. For example, 1 KB = 1024 bytes, 1 MB = 1024² bytes, and 1 GB = 1024³ bytes.
:::
