...
[workflow-outputs-final]: /nextflow_docs/nextflow_repo/docs/tutorials/workflow-outputs.mdx
[workflow-outputs-first-preview]: /nextflow_docs/nextflow_repo/docs/migrations/24-04.mdx
