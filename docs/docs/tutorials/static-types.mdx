---
title: Migrating to static types
description: A step-by-step guide to adopting static type annotations in Nextflow pipelines.
---
...
[dataflow-type-channel]: ../reference/stdlib-types#channele
...
[workflow-params-def]: ../workflow#parameters
