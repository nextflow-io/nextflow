...
:::note
Parameters used only in the config file should be declared there, not in the script. Since rnaseq-nf has no such parameters, all parameters are declared in the script. See [Parameters][config-params] for more information.
:::
...
The [strict syntax][strict-syntax-page] remains optional in Nextflow 25.10. However, it is required to use type annotations.
...
The [each][process-input-each] input qualifier is not supported by typed processes. Use the [combine][operator-combine] operator to create a single tuple channel instead.
...
Some [standard library][stdlib-types] functions and [operators][operator-page] have ambiguous return types. While you can still use them with static types, the type checker will not be able to fully validate your code.
...
:::tip
The commonly-used operators listed under [Channels][dataflow-type-channel] have well-defined return types and are recommended for use with static types.
:::
...
[config-params]: /docs/config.mdx#parameters
[dataflow-type-channel]: /docs/reference/stdlib-types.mdx#channel
[devenv-page]: /docs/developer-env.mdx
[operator-combine]: /docs/reference/operator.mdx#combine
[operator-page]: /docs/reference/operator.mdx
[process-input-each]: /docs/reference/process.mdx#input-each
[process-typed-page]: /docs/process-typed.mdx#processes-typed
[rnaseq-nf-page]: /docs/tutorials/rnaseq-nf.mdx
[strict-syntax-deprecated]: /docs/strict-syntax.mdx#deprecated-syntax
[strict-syntax-page]: /docs/strict-syntax.mdx
[workflow-special-operators]: /docs/workflow.mdx#dataflow
[stdlib-types]: /docs/reference/stdlib-types.mdx#types
[syntax-process-typed]: /docs/reference/syntax.mdx#process-typed
[workflow-params-def]: /docs/workflow.mdx#parameters
