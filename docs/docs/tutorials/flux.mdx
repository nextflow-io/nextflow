---
title: Using Nextflow with Flux
description: How to set up and run Nextflow pipelines using the Flux Framework resource manager.
---
...
[flux-executor]: ../executor#flux-executor