...
[cli-clone]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#clone
[cli-config]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#config
[cli-drop]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#drop
[cli-fs]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#fs
[cli-inspect]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#inspect
[cli-kuberun]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#kuberun
...
[cli-pull]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#pull
[cli-reference]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx
[cli-run]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#run
[cli-secrets]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#secrets
[cli-view]: /nextflow_docs/nextflow_repo/docs/reference/cli.mdx#view
