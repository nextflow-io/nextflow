...
See [info][cli-module-info] for more information.
...
Run `nextflow module info nf-core/salmon` to see the available params for the module.
...
[cli-module-info]: ./reference/cli#module-info
