...
The `Channel` class implements the channel factory methods, and it is exposed directly to Nextflow scripts. See [Channel factories][channel-factory] for details.
