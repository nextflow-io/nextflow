...
description: How Nextflow caches task executions and how to use the -resume flag to skip previously completed tasks.
---
...
```nextflow title="<filename>.config"
process FOO {
  cache false
  // ...
}
