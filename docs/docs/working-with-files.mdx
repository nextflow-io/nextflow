...
Nextflow provides a rich set of helper methods for working with files and directories. This page covers how to open, read, write, copy, move, and delete files in Nextflow scripts.
