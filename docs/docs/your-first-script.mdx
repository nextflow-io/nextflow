...
description: Run, modify, and configure your first Nextflow pipeline.
---
...
-  Nextflow version 25.10 or later.
   See [Installation ](install-page) for installation instructions. If you have an older version, see [Updating Nextflow](updating-nextflow) to update.
:::

## Run a pipeline

You will run a basic Nextflow pipeline that splits a string of text into two files and then converts lowercase letters to uppercase letters.

The pipeline is defined in the following script:
