...
<AddedInVersion version="25.04.0">
To enable the [strict syntax][strict-syntax-page], set the `NXF_SYNTAX_PARSER` environment variable to `v2`:
...
[config-syntax]: /docs/config.mdx#syntax
[dsl1-page]: /docs/migrations/dsl1.mdx
[lib-directory]: /docs/sharing.mdx#the-lib-directory
[module-params]: /docs/module.mdx#module-parameters
[operator-filter]: /docs/reference/operator.mdx#filter
[plugins-dev-page]: /docs/plugins/developing-plugins.mdx
[process-when]: /docs/process.mdx#when
[stdlib-namespaces-channel]: /docs/reference/stdlib-namespaces.mdx
[stdlib-types-channel]: /docs/reference/stdlib-types.mdx#channele
