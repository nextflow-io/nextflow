...
description: How to update Nextflow scripts and configuration files to comply with the strict Nextflow language specification.
---
...
[module-params]: ./module#module-parameters
