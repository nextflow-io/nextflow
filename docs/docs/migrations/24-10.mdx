...
[install-standalone]: /docs/install.mdx#standalone-distribution
[module-params]: /docs/module.mdx#module-parameters
[spot-retries-page]: /docs/guides/updating-spot-retries.mdx
[strict-syntax-page]: /docs/strict-syntax.mdx
[syntax-page]: /docs/reference/syntax.mdx
[task-previous-execution-trace]: /docs/process.mdx#dynamic-task-resources-with-previous-execution-trace
