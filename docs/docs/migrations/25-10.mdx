...
:::note
Type annotations require the [strict syntax][strict-syntax-page]. Set the `NXF_SYNTAX_PARSER` environment variable to `v2` to enable:
...
[aws-java-sdk-v2-page]: /docs/guides/aws-java-sdk-v2.mdx
[cli-auth]: /docs/reference/cli.mdx#auth
[cli-launch]: /docs/reference/cli.mdx#launch
[config-workflow-handlers]: /docs/config.mdx#workflow-handlers
[dataflow-page]: /docs/channel.mdx
[dev-plugins-extension-points-config]: /docs/plugins/developing-plugins.mdx#dev-plugins-extension-points-config
[dynamic-directives]: /docs/process.mdx#dynamic-directives
[gradle-plugin-page]: /docs/guides/gradle-plugin.mdx
[migrating-workflow-outputs]: /docs/tutorials/workflow-outputs.mdx#migrating-workflow-outputs
[migrating-static-types]: /docs/tutorials/static-types.mdx
[plugin-registry-page]: /docs/plugins/plugin-registry.mdx
...
[workflow-params-legacy]: /docs/workflow.mdx#legacy-parameters
