...
:::note
Static typing requires the [strict syntax][strict-syntax-page]. Set the `NXF_SYNTAX_PARSER` environment variable to `v2` to enable:
...
:::note
The new syntax for workflow handlers require the [strict syntax][strict-syntax-page]. Set the `NXF_SYNTAX_PARSER` environment variable to `v2` to enable:
