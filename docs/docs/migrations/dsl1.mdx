---
title: Migrating from DSL1
description: How to migrate Nextflow pipelines from DSL1 to DSL2.
---
...
[module-page]: ../module
[operator-branch]: ../reference/operator#branch
...
[operator-multimap]: ../reference/operator#multimap
[operator-view]: ../reference/operator#view
[process-input-tuple]: ../process#input-tuples-tuple
