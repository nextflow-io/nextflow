...
description: How to set up a Nextflow development environment.
---
...
[devenv-docker]: ./developer-env#docker
[devenv-extensions]: ./developer-env#extensions
[devenv-git]: ./developer-env#git
[devenv-nextflow]: ./developer-env#nextflow
[devenv-vscode]: ./developer-env#vs-code
[devenv-wsl]: ./developer-env#windows-subsystem-for-linux
