...
[plugin-registry-claim]: /docs/plugins/plugin-registry.html#claiming-a-plugin
[dev-plugins-extension-points]: /docs/plugins/developing-plugins.mdx#extension-points
[dev-plugins-template]: /docs/plugins/developing-plugins.mdx#nextflow-plugin-template
[gradle-plugin-page]: /docs/guides/gradle-plugin.mdx
[gradle-plugin-test]: /docs/guides/gradle-plugin.mdx#testing-a-plugin
[plugin-page-migrate]: /docs/guides/migrate-plugin.mdx
[plugin-registry-claim]: /docs/plugins/plugin-registry.mdx#claiming-a-plugin
[plugin-registry-access-token]: /docs/plugins/plugin-registry.mdx#creating-an-access-token
[plugin-registry-page]: /docs/plugins/plugin-registry.mdx
[using-plugins-page]: /docs/plugins/using-plugins.mdx
