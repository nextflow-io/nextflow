...
[config-scopes-page]: /docs/developer/config-scopes.mdx#config-scopes
[gradle-plugin-create]: /docs/guides/gradle-plugin.mdx#creating-a-plugin
[process-directives]: /docs/process.mdx#directives
[process-ext]: /docs/reference/process.mdx#ext
[remote-files]: /docs/working-with-files.mdx#remote-files
