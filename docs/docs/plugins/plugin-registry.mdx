...
[gradle-plugin-publish]: /docs/guides/gradle-plugin.mdx#publishing-a-plugin
[gradle-plugin-readme]: /docs/guides/gradle-plugin.mdx#readme-md-requirement
[migrate-plugin-page]: /docs/guides/migrate-plugin.mdx
