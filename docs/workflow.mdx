...
:::note
This page describes the original workflow syntax. Nextflow also supports a [typed workflow syntax](./workflow-typed.mdx) with statically typed inputs and outputs. See [Static typing](./static-typing.mdx) for an overview.
:::
