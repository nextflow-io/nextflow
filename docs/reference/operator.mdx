...
See [Operators][operator-typed] for the core operator reference. See [Using operators with static typing][static-types-operators] for the migration guide.
...
[process-cache]: ./process/directives/cache
