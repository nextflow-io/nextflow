...
The object size threshold used for multipart S3 transfers (defaultsame as `aws.client.minimumPartSize`).
...
The compute environment ID in your Seqera Platform account used to launch pipelines (defaultthe primary compute environment in the selected workspace).
...
[timeline-report]: /nextflow_docs/nextflow_repo/docs/reports.mdx#timeline-report
