...
See the [Amazon Web Services][aws-page] and [Amazon S3][amazons3-page] pages for more information.
...
<DeprecatedInVersion version="24.02.0-edge">
...
See the [Azure][azure-page] page for more information.
...
<AddedInVersion version="23.05.0">
</AddedInVersion>
...
Specify the client ID for an Azure [managed identity](https://learn.microsoft.com/en-us/entra/identity/managed-identities-azure-resources/overview). See [Managed identities][azure-managed-identities] for more details. Defaults to environment variable `AZURE_MANAGED_IDENTITY_USER`.

##### `azure.managedIdentity.system`

When `true`, uses the system-assigned [managed identity](https://learn.microsoft.com/en-us/entra/identity/managed-identities-azure-resources/overview) to authenticate Azure resources. See [Managed identities][azure-managed-identities] for more details. Defaults to environment variable `AZURE_MANAGED_IDENTITY_SYSTEM`.
...
See the [Charliecloud][container-charliecloud] page to learn more about how to use Charliecloud containers with Nextflow.
...
See the [Workflow diagram][workflow-diagram] page to learn more about the workflow graph that can be generated by Nextflow.
...
See the [Docker][container-docker] page to learn more about how to use Docker containers with Nextflow.
...
See the [Google Cloud][google-page] page for more information.
...
<AddedInVersion version="22.09.6-edge">
</AddedInVersion>
...
Allows the definition of one or more pod configuration options such as environment variables, config maps, secrets, etc. It allows the same settings as the [pod][process-pod] process directive.
...
See the [Kubernetes][k8s-page] page for more details.
...
Any SMTP configuration property supported by the [Java Mail API](https://javaee.github.io/javamail/docs/api/com/sun/mail/smtp/package-summary.html#properties).
...
See [Sharing][sharing-page] to learn how to publish your pipeline to GitHub, BitBucket or GitLab.

## `nextflow`

<DeprecatedInVersion version="24.10.0">
The `nextflow.publish` scope has been renamed to `workflow.output`. See [workflow][config-workflow] for more information.
</DeprecatedInVersion>
...
The notification message is sent my using the STMP server defined in the configuration [mail][config-mail] scope.
...
See the [Podman][container-podman] page to learn more about how to use Podman containers with Nextflow.
...
See the [Shifter][container-shifter] page to learn more about how to use Shifter containers with Nextflow.
...
:::note
  Leave `ociAutoPull` disabled if willing to build a Singularity native image with Wave (see the [Build Singularity native images][wave-singularit] section).
:::
...
:::note
  Leave `ociMode` disabled if you are willing to build a Singularity native image with Wave (see the [Build Singularity native images][wave-singularit] section).
:::
...
See the [Singularity][container-singularity] page to learn more about how to use Singularity containers with Nextflow.
...
Comma separated list of fields to be included in the report. The available fields are listed at [here][trace-fields].
...
See the [Trace file][trace-report] section to learn more about the execution report that can be generated by Nextflow.
...
[azure-managed-identities]: /nextflow_docs/nextflow_repo/docs/azure/managed-identities.mdx
