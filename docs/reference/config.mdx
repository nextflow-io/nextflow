...
The service account must have the IAM roles listed in the [Google Cloud Batch documentation for Nextflow](https://cloud.google.com/batch/docs/nextflow), otherwise Cloud Batch jobs can remain stuck in the `SCHEDULED` state indefinitely.
