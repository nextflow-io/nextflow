...
Enable the use of Conda recipes defined by using the [process-conda][process-conda] directive. (default: `false`).
...
Enable the use of Spack recipes defined by using the [process-spack][process-spack] directive. (default: `false`).
