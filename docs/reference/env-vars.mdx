...
Defines a custom plugin registry or plugin release URL for testing plugins outside of the main registry. See [Testing plugins][testing-plugins] for more information.
...
[testing-plugins]: /nextflow_docs/nextflow_repo/docs/developer/plugins.mdx#testing-plugins