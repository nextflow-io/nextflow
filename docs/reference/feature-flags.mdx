...
When `true`, enables the unified package management system with the [`package`][process-package] process directive. See [Package management][package-page] for more information. Requires the [strict parser][strict-syntax-page].
