...
<DefinitionList>
    ...
    <DefinitionDescription>
        ...
        :::warning{title="Changed in version 22.03.0-edge"}
        DSL2 was made the default DSL version.
        :::

        :::warning{title="Changed in version 22.12.0-edge"}
        DSL1 was removed.
        :::
    </DefinitionDescription>
    ...
    <DefinitionDescription>
        :::note{title="Added in version 22.05.0-edge"}
        :::
    ...
    <DefinitionDescription>
        ...
        *Experimental: may change in a future release.*
        ...
        When `true`, enables the use of the [workflow output definition][workflow-output-def].
    </DefinitionDescription>
    ...
    <DefinitionDescription>
        :::note{title="Added in version  21.11.0-edge"}
        :::
    ...
    <DefinitionDescription>
        ...
        :::warning{title="Changed in version 25.04.0"}
...
[module-binaries]: /nextflow_docs/nextflow_repo/docs/module#module-binaries
[workflow-output-def]: /nextflow_docs/nextflow_repo/docs/workflow#workflow-outputs
[workflow-recursion]: /nextflow_docs/nextflow_repo/docs/workflow#recursion