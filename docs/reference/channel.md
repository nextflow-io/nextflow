...
The following snippet shows how to create a channel (`ch`) using this method. It searches for files published by a specific workflow that includes the annotation `sample:'beta'`.

```nextflow
channel
    .queryLineage(workflowRun: 'lid://0d1d1622ced3e4edc690bec768919b45', annotations: [sample:'beta'])
```
