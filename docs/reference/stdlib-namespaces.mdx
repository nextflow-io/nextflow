...
[operator-branch]: /nextflow_docs/nextflow_repo/docs/operator.mdx#branch
[operator-grouptuple]: /nextflow_docs/nextflow_repo/docs/operator.mdx#grouptuple
[operator-multimap]: /nextflow_docs/nextflow_repo/docs/operator.mdx#multimap
