...
[cli-lineage]: /nextflow_docs/nextflow_repo/docs/reference/cli#lineage
[glob]: http://docs.oracle.com/javase/tutorial/essential/io/fileOps.html#glob
[operator-ifempty]: /nextflow_docs/nextflow_repo/docs/reference/operator#ifempty
[process-additional-options]: /nextflow_docs/nextflow_repo/docs/reference/process#options
[operator-take]: /nextflow_docs/nextflow_repo/docs/reference/operator#take
[operator-until]: /nextflow_docs/nextflow_repo/docs/reference/operator#until
