...
# // This is used to break the section indentation
...
[azurebatch-executor]: /nextflow_docs/nextflow_repo/docs/executor#azure-batch
[cache-resume-page]: /nextflow_docs/nextflow_repo/docs/cache-and-resume
[channel-topic]: /nextflow_docs/nextflow_repo/docs/reference/channel#topic
...
[dynamic-directives]: /nextflow_docs/nextflow_repo/docs/process#dynamic-directives
[dynamic-task-resources]: /nextflow_docs/nextflow_repo/docs/process#dynamic-task-resources
...
[lsf-executor]: /nextflow_docs/nextflow_repo/docs/executor#lsf
[pbs-executor]: /nextflow_docs/nextflow_repo/docs/executor#pbs-torque
[pbspro-executor]: /nextflow_docs/nextflow_repo/docs/executor#pbs-pro
[process-page]: /nextflow_docs/nextflow_repo/docs/process
[process-native]: /nextflow_docs/nextflow_repo/docs/process#native-execution
[getstarted-resume]: /nextflow_docs/nextflow_repo/docs/your-first-script#modify-and-resume
[secrets-page]: /nextflow_docs/nextflow_repo/docs/secrets
[sge-executor]: /nextflow_docs/nextflow_repo/docs/executor#sge
[slurm-executor]: /nextflow_docs/nextflow_repo/docs/executor#slurm
[spack-page]: /nextflow_docs/nextflow_repo/docs/spack
[stdlib-namespaces-workflow]: /nextflow_docs/nextflow_repo/docs/reference/stdlib-namespaces#workflow
[stdlib-types-duration]: /nextflow_docs/nextflow_repo/docs/reference/stdlib-types#duration
[stdlib-types-memoryunit]: /nextflow_docs/nextflow_repo/docs/reference/stdlib-types#memoryunit
