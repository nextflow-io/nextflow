...
This section demonstrates how to migrate a pipeline to static typing using [rnaseq-nf](https://github.com/nextflow-io/rnaseq-nf/tree/v2.4) (v2.4) as an example. See [Getting started with rnaseq-nf][rnaseq-nf-page] for an introduction to the pipeline.
...
See [Typed processes][process-typed-page] for an overview of typed processes.
...
The [strict syntax parser][strict-syntax-page] is required to use static typing. It is enabled by default in Nextflow 26.04.
...
When preparing for the strict parser, try to address [deprecation warnings][strict-syntax-deprecated] as much as possible. For example:
...
- [Typed processes][process-typed-page]
...
[stdlib-types]: ../reference/semantics#values
