...
The **Convert script to static types** command automatically converts process inputs and outputs to records when the language version is set to 26.04. See {ref}`migrating-static-types` for more information.
...
The outputs must satisfy the following conditions to be converted:
