...
:::note
This page describes the original process syntax. Nextflow also supports a [typed process syntax](./process-typed.mdx) with statically typed inputs and outputs. See [Static typing](./static-typing.mdx) for an overview.
:::
...
[process-maxforks]: ./reference/process#maxforks
[process-maxretries]: ./reference/process#maxretries
...
[process-tag]: ./reference/process#tag
