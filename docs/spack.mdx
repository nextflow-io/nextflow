---
title: Spack environments
description: Use Spack to manage software dependencies, including recipes, environment files, and multi-architecture builds.
---
...
[config-spack]: ./reference/config/spack
