...
2. Add the following property:
    ...
    Replace `<API_KEY>` with your plugin registry API key. See [Creating an access token][plugin-registry-access-token] for more information about creating an API key.
