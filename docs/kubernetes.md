...
See [Amazon EKS](https://docs.seqera.io/fusion/guide/aws-eks) for instructions to set up Fusion in Amazon EKS compute environments and [Google GKE](https://docs.seqera.io/fusion/guide/gcp-gke) for guides to set up Fusion in Google GKE compute environments.
