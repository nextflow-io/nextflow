---
title: Secrets
description: Securely manage and inject sensitive credentials using the built-in secrets store.
---
...
Secrets can be accessed by processes using the [secret][process-secret] directive. For example:
