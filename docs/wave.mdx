...
description: Use Wave to automatically build and provision container images on demand.
---
...
To include custom scripts or files, use the module `resources/` directory instead. Wave automatically includes its contents in the container build context.
:::
...
[conda-pypi]: ./conda#python-packages-from-pypi
[config-singularity]: ./reference/config/singularity
[config-wave]: ./reference/config/wave
[fusion-page]: ./fusion
[module-directory]: ./modules#local-modules
