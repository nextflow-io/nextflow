...
google.lifeSciences.serviceAccountEmail        Define the email of the service account to install on the VM. If not specified, the default Compute Engine service account for the project will be used.
