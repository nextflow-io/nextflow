...
NXF_ENABLE_SECRETS              Enable Nextflow secrets features (default: ``true`` since version ``22.09.2-edge``, but the environment variable can be used since version ``21.09.0-edge`` or later)
