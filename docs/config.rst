...
retryMode                   The retry mode configuration in case of failed calls to AWS services<https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-retries.html> (requires release > ``22.09.2-edge``)
=========================== ================
