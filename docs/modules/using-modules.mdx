---
title: Using modules
description: Discover, install, and run Nextflow modules from the module registry.
---
...
See [module search][cli-module-search] for the full command reference.
...
See [module install][cli-module-install] for the full command reference.
...
See [module list][cli-module-list] for the full command reference.
...
See [module view][cli-module-view] for the full command reference.
...
See [include declarations][syntax-include] for a full description of the include syntax.
...
See [module remove][cli-module-remove] for the full command reference.
