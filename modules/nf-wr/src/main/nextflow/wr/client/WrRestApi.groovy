...
class WrRestApi {
    ...
    List<Map> add(List<List> argList) {
        ...
        argList.each {
            ...
            Map args = [cmd: cmd, cwd: cwd, cwd_matters: cwdMatters, rep_grp: grp, req_grp: grp, override: override, retries: 0, rerun: true, cpus: cpus, memory: mem, time: t, disk: d, mounts: m, on_exit: behaviours]
