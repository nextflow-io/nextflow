...
class CmdModuleInstall extends CmdBase {
    ...
    @Parameter(names = ["-update-deps"], description = "For an already-installed module, update its vendored dependencies to match meta.yml, without reinstalling the module", arity = 0)
