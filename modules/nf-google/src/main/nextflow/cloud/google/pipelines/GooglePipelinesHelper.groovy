...
class GooglePipelinesHelper {
    ...
    Resources configureResources(String machineType, String projectId, List<String> zone, List<String> region, String diskName, int diskSizeGb, List<String> scopes = null, boolean preEmptible = false) {
