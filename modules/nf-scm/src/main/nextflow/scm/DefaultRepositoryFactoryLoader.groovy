...
/**
 * Default implementation of repository factory loader.
 * Uses pf4j plugin manager to discover repository factories.
 *
...
@Singleton
@CompileStatic
class DefaultRepositoryFactoryLoader implements RepositoryFactoryLoader {

    private static List<RepositoryFactory> factories0


    private List<RepositoryFactory> factories() {
        if( factories0 == null ) {
            factories0 = new DefaultPluginManager().getExtensions(RepositoryFactory)
        }
        return factories0
    }
