...
/**
 * Implements an executor for PBS/Torque cluster
 *
...
class PbsExecutor extends AbstractGridExecutor {
    ...
    List<String> getSubmitCommandLine(TaskRun task, Path scriptFile ) {
        // in some PBS implementations, the submit command will fail if the script name starts with a dot, e.g. `.command.run`
    ...
    def parseJobId( String text ) {
        // return always eturn the last line
