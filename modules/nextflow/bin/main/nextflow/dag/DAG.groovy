...
class DAG {
     ...
     *
     * @param label the label associated with the process
     * @param inputs the list of inputs entering the process
     ...
     * @param inputs the operator input(s). Can be either a single channel, or a list of channels.
     * @param outputs The operator output(s). Can be either a single channel, a list of channels, or {@code null} if the operator has no output.
     */
     ...
     * @param source either a dataflow channel, or a list of channels.
     */
     ...
     * @param inbounds the inbound channels to this vertex
     * @param outbounds the outbound channels leaving this vertex
     */
    @PackageScope
    ...
    private void inbound( Vertex vertex, ChannelHandler entering )  {
        ...
        // link the edge to the given `edge`
        else if( edge.to == null ) {
            edge.to = vertex
        }
        // handle the special case for the dataflow variable
        // this kind of channel can be used as an input more than once
        ...
        // the same channel - apart from the above case - cannot be used multiple times as an input
    ...
    String dumpActiveNodes() {
        ...
        // otherwise, fall back on other nodes
    ...
    class Vertex {
        ...
        /**
         * One or more {@link DataflowProcessor}s associated with this graph node
         */
    ...
    /**
     * A simple wrapper object to handle a channel and its associated label
     */
