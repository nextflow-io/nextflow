...
class SingularityCache {
    ...
    Path downloadSingularityImage0(String imageUrl, Path localPath) {
        ...
        if( missingCacheDir )
            log.warn1 "Singularity cache directory has not been defined, eg in variable NXF_SINGULARITY_CACHEDIR -- Remote image will be stored in the path: $localPath.parent"
