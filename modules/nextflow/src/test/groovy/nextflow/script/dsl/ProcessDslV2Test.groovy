...
class ProcessDslV2Test extends Specification {
    ...
    def 'should create input directives' () {
        ...
        when:
        dsl._input_('infile', Path)
        dsl._input_('x', String)
        dsl._input_('y', String)
    ...
    def 'should create output directives' () {
        ...
        dsl._output_('file1', Path, { file('$file0') })
        dsl._output_('file2', Path, { file('$file1') })
        dsl._output_('file3', Path, { file('$file2') })
        dsl._unstage_files('$file0', { file1 })
        dsl._unstage_files('$file1', { file2 })
        dsl._unstage_files('$file2', { file3 })
        ...
        config.getOutputs().getFiles().keySet() == [ '$file0', '$file1', '$file2' ].toSet()
    ...
    def 'should clone config object' () {
        ...
        dsl.memory '10 GB'
        dsl._input_('foo', String)
        dsl._input_('sample', Path)
