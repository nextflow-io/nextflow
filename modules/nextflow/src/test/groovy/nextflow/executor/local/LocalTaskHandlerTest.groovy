...
class LocalTaskHandlerTest extends Specification {
    ...
    def 'should create fusion process builder' () {
        ...
        and:
        builder.command() == ['sh','-c','docker run -i -e "FUSION_WORK=/fusion/http/some/work/dir" -e "FUSION_TAGS=[.command.*|.exitcode|.fusion.*](nextflow.io/scratch=false),[*](nextflow.io/scratch=true)" --rm --privileged ubuntu:latest /usr/bin/fusion bash \'/fusion/http/some/work/dir/.command.run\'']
