 ...
 */
class TgccExecutorTest extends Specification {

    def testParseJob() {

        given:
        def exec = [:] as TgccExecutor
    ...
    def testGetCommandLine() {
        ...
        def exec = Spy(TgccExecutor) { getSession()>>session }
