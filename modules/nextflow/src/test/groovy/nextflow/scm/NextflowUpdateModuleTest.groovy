 ...
 */
class NextflowUpdateModuleTest extends Specification {
...
//    }
    ...
    def 'should clone and update submodules' () {
        ...
        when: 'legacy'
        def manager = new NextflowAssetManager("file:${baseFolder}/pipe_x")
    ...
    def 'should not clone submodules' () {
        ...
        when:'legacy'
        def manager = new NextflowAssetManager("file:${baseFolder}/pipe_2")
        manager.setStrategyType(AssetManager.RepositoryStrategyType.LEGACY)
        manager.download()
        manager.updateModules()
        ...
        when: 'multi-revision'
        manager = new NextflowAssetManager( "file:${baseFolder}/pipe_2")
        manager.setStrategyType(AssetManager.RepositoryStrategyType.MULTI_REVISION)
        manager.download()
        manager.updateModules()
    ...
    def 'should clone selected submodules' () {
        ...
        when:
        def manager = new NextflowAssetManager( "file:${baseFolder}/pipe_3")
        manager.setStrategyType(AssetManager.RepositoryStrategyType.LEGACY)
        manager.download()
        manager.updateModules()
        ...
        when: 'multi-revision'
        manager = new NextflowAssetManager( "file:${baseFolder}/pipe_3" )
        manager.setStrategyType(AssetManager.RepositoryStrategyType.MULTI_REVISION)
        manager.download()
        manager.updateModules()
