...
class SpackCacheTest extends Specification {
    ...
    def 'should create a spack env with a yaml file' () {
        ...
        1 * cache.runCommand( "spack env create -d $PREFIX /usr/base/$ENV ; spack env activate $PREFIX ; spack env view enable ; spack concretize -f ; spack install -y ; spack env deactivate" ) >> null
        result == PREFIX
