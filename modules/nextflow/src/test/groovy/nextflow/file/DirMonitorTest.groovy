 ...
 */
class DirMonitorTest extends Specification {

    def 'should watch for a new file' () {

        given:
        def folder = Files.createTempDirectory('test')
        def watcher = new DirMonitor('glob', "$folder/", 'hola.txt', false, 'create', folder.getFileSystem())
    ...
    def 'should watch a path for new files' () {
        ...
        given:
        def folder = Files.createTempDirectory('test')
        def watcher = new DirMonitor('glob', "$folder/", '*.txt', false, 'create', folder.getFileSystem())
    ...
    def 'should watch a path for modified and deleted files' () {
        ...
        def watcher = new DirMonitor('glob', "$folder/", '*', false, 'modify,delete', folder.getFileSystem())
    ...
    def 'should watch into subdirs' () {
        ...
        def watcher = new DirMonitor('glob', "$folder/", '**/h*', false, 'create', folder.getFileSystem())
