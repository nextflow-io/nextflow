...
class TrieTest extends Specification {
    ...
    def 'should add path'() {
        ...
        node.children.size() == 1
        and:
        node.children[0].vertex == 'alpha'
        node.children[0].children[0].vertex == 'beta'
        ...
        then:
        node.children[0].children[0].vertex == 'beta'
        node.children[0].children[0].children[0].vertex == 'delta'
        node.children[0].children[0].children[0].children[0].vertex == 'omega'
